...
func TestGetPodWithoutResourceRequestsLimits(t *testing.T) {
	...
	aciMocks.MockGetContainerGroupInfo =
		func(ctx context.Context, resourceGroup, cgName, nodeName string) (*azaci.ContainerGroup, error) {
...
func TestGetPodWithContainerID(t *testing.T) {
	...
	aciMocks := createNewACIMock()
	cgID := ""
	aciMocks.MockGetContainerGroupInfo = func(ctx context.Context, resourceGroup, cgName, nodeName string) (*azaci.ContainerGroup, error) {
