...
type AzClientsInterface interface {
	...
	CreateContainerGroup(ctx context.Context, resourceGroup, podNS, podName string, cg *azaci.ContainerGroup) error
	GetContainerGroupInfo(ctx context.Context, resourceGroup, cgName, nodeName string) (*azaci.ContainerGroup, error)
...
func CreateACIClients(ctx context.Context, azConfig auth.Config) (*ACIClients, error) {
	obj := ACIClients{}
...
func (a *ACIClients) GetContainerGroup(ctx context.Context, resourceGroup, containerGroupName string) (*azaci.ContainerGroup, error) {
...
func (a *ACIClients) CreateContainerGroup(ctx context.Context, resourceGroup, podNS, podName string, cg *azaci.ContainerGroup) error {
	logger := log.G(ctx).WithField("method", "CreateContainerGroup")
	ctx, span := trace.StartSpan(ctx, "aci.CreateContainerGroup")
	defer span.End()

	cgName := util.ContainerGroupName(podNS, podName)
	cg.Name = &cgName
	var rawResponse *http.Response

	ctxWithResp := runtime.WithCaptureResponse(ctx, &rawResponse)
	logger.Infof("creating container group with name: %s", *cg.Name)
	_, err := a.ContainerGroupClient.BeginCreateOrUpdate(ctxWithResp, resourceGroup, *cg.Name, *cg, nil)
	if err != nil {
...
func (a *ACIClients) GetContainerGroupInfo(ctx context.Context, resourceGroup, cgName, nodeName string) (*azaci.ContainerGroup, error) {
...
func (a *ACIClients) GetContainerGroupListResult(ctx context.Context, resourceGroup string) ([]*azaci.ContainerGroup, error) {
...
func (a *ACIClients) ListCapabilities(ctx context.Context, region string) ([]*azaci.Capabilities, error) {
...
func (a *ACIClients) DeleteContainerGroup(ctx context.Context, resourceGroup, cgName string) error {
...
func (a *ACIClients) ListLogs(ctx context.Context, resourceGroup, cgName, containerName string, opts api.ContainerLogOpts) (*string, error) {
...
func (a *ACIClients) ExecuteContainerCommand(ctx context.Context, resourceGroup, cgName, containerName string, containerReq azaci.ContainerExecRequest) (*azaci.ContainerExecResponse, error) {
