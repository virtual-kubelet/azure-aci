...
func (c *Client) GetProfile(ctx context.Context, resourceGroup, name string) (network.Profile, error) {
	return c.profileClient.Get(ctx, resourceGroup, name, "")
...
func (c *Client) CreateOrUpdateProfile(ctx context.Context, resourceGroup string, p network.Profile) (network.Profile, error) {
	return c.profileClient.CreateOrUpdate(ctx, resourceGroup, *p.Name, p)
	/*
		urlParams := url.Values{
			"api-version": []string{apiVersion},
		}
