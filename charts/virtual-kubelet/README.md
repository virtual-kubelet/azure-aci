...
$ export VK_RELEASE=virtual-kubelet-azure-aci-1.4.3
...
virtual-kubelet-aci                    Ready     agent     2m         v1.19.10-vk-azure-aci-v1.4.3-dev
```
</details><br/>
...
| image.tag                                      | Image release version/tag.                                                                                            | `1.4.3`                               |
